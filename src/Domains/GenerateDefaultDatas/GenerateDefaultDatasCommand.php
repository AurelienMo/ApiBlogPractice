...
namespace App\Domains\GenerateDefaultDatas;
...
{
    const PATH_TO_ENTRY_POINT = __DIR__.'/../../../var/fixtures/prod/00_load.yml';
    ...
    {
        $this
            ->setName('app:load-default-datas')
            ->setDescription('Allow to load default datas');
    }
